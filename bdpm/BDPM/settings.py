"""
Django settings for BDPM project.
...
SECRET_KEY = "django-insecure-04@n$l)zpvls05@vr=-o3xy1s#++9l!m_$vg26)$*)amzu5n(y"
...
LOGIN_URL = 'login'  # Assuming 'login' is the name of your custom login URL pattern
LOGIN_REDIRECT_URL = 'home'  # Assuming 'home' is the name of the URL pattern for your home view
